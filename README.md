...
打印模板平台是一个**跨客户共享打印设计**的中心化市场:一个客户设计好的模板可推送到平台,其他客户从平台浏览、下载安装到本地使用。适合总部统一分发标准模板、各分子公司按需安装。
...
| **客户端** | 各客户服务器(装 zhiz_print);设计 → 推送到中心,或从中心拉取安装 |
